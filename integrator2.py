...
def Login_Control():
    ...
    # 使用CSS固定定位的登录表单
    # #tymx10.14修改/* CSS精确定位 */right: 40% !important;
...
def main():
 ...
 # tym10.14以下修改（隐藏顶部streamlit栏，标题和欢迎语优化显示）=========================================================
    st.markdown("""
        <style>
    ...
    st.markdown(
        ...
        <div style="display: flex; align-items: center; margin-bottom: 1rem;">
            <div style="flex: 3; text-align: left;">
                <img src="data:image/jpeg;base64,{img_base64}" style="max-width: 100%; height: auto; object-fit: contain;" />
            </div>
            <div style="
                flex: 1;
                width: 100%;
                ...
                align-items: center;
                background-color: #007bff; /* 蓝色背景，确保该属性存在 */
                border-radius: 8px;
                margin-left: 0rem;
                padding: 0.5rem 1rem;
            ">
...
# 以上修改==================================================
    ...
    # st.markdown(
    #     f"""
    #     <div style="position: fixed; top: 10px; right: 10px; font-size: 20px;">
    #         {my_login_user[0]} 欢迎您!
    #     </div>
    #     """,
    #     unsafe_allow_html=True
